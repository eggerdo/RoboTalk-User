package org.dobots.robotalk.user.utility;
...
import org.dobots.robotalk.user.RoboTalkActivity_User;
...
//    	}
    ...
    public static void showToast(String textToShow, int duration) {
    	Toast oToast = Toast.makeText(RoboTalkActivity_User.getContext(), textToShow, duration);
		oToast.show();
	}
