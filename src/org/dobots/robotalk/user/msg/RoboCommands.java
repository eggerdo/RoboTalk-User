...
import org.dobots.robotalk.user.msg.RoboCommandTypes.Request;
...
public class RoboCommands {
	...
	public class DriveCommand extends BaseCommand {
		...
		public DriveCommand(Move i_eMove, double i_dblSpeed, double i_dblAngle) {
		...
		public DriveCommand(JSONObject i_oObj) throws JSONException {
			...
			eMove 		= (Move)data.get(RoboCommandTypes.F_MOVE);
		...
		public JSONObject toJSON() {
			...
			try {
				data.put(RoboCommandTypes.F_MOVE, 	eMove);
	...
	public static DriveCommand createDriveCommand(Move i_eMove, double i_dblSpeed, double i_dblAngle) {
		return getInstance().new DriveCommand(i_eMove, i_dblSpeed, i_dblAngle);
	}
	
	public static DriveCommand createDriveCommand(Move i_eMove, double i_dblSpeed) {
